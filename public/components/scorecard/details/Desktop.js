...
class Desktop extends React.Component {
  ...
  const copyright = <Copyright />;
    const rules = this.props.scorecard.desktop.rules;
    const mustFix = [];
    const shouldFix = [];
    const onTarget = [];
      ...
      <div className="desktop">
        ...
        <div className="laptop-container">
          ...
          <img className="laptop-screenshot"
               src={`data:image/jpeg;base64, ${this.props.scorecard.desktop.base64Image}`}
               alt="desktop screenshot" />
        </div>

        <div className="score-coin-container">
          <div className="score-coin desktop-coin">
        ...
        <div className="rules-container">
          <div className="title">
            {this.props.scorecard.desktop.title}
          </div>

          <div className="explanation-text-top">
            Traffic from desktop devices is growing fast. Optimize your website for <br />
            desktop or you'll miss out on valuable traffic, leads, and revenue.
          </div>

          <div className="explanation-text-bottom tk-bookmania">
            People are five times more likely to leave a desktop site that isn't desktop friendly. Nicely done. It
            looks like people visiting {this.props.scorecard.domainName} on their desktop phones experience a well-designed
            desktop site.
          </div>
